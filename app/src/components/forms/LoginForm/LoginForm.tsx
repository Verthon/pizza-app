...
export const LoginForm = () => {
  ...
  return (
    <Styled.Form onSubmit={handleSubmit(onSubmit)} noValidate>
      <InputField label="Email" type="email" name="email" control={control} placeholder="Your email" />
      <InputField label="Password" type="password" name="password" control={control} placeholder="Your password" />
      <Button type="submit" disabled={isDisabled} $loading={formState.isSubmitting}>
        Login
      </Button>
    </Styled.Form>
  )
